...
export default function Experience() {
  ...
  return (
    <>        
    <div id='experience' className='bg-[#F2F5F7] w-full min-h-screen px-28 pt-28 pb-48 grid grid-cols-5 text-left gap-y-12'>
        {/* ######### Experience ############### */}
        ...
        {/* empty */}
        <div className='col-span-2 border-b-2 pb-6'>
        </div>
        {/* Codekul */}
        <div className='col-span-3 border-b-2 pb-6'>
            <p className='font-semibold text-cyan-950 text-2xl font-Playfair leading-6 mb-2'>
