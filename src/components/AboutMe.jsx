...
import ResearchWebsiteButton from "./ResearchWebsiteButton";
...
export default function AboutMe() {
  return (
    ...
    >
      <div className="grid lg:grid-cols-3 gap-4 w-full px-4 md:px-8 py-12 md:py-24 text-lg text-left font-light text-[#191D26]">
        <div className="lg:col-span-2">
          <p className="font-semibold text-cyan-950 text-xl leading-relaxed">
            ― MY BACKGROUND
          </p>
          <p className="leading-relaxed text-justify">
            I am a researcher and data scientist with a background in
            engineering and advanced analytics, currently focused on the
            intersection of Artificial Intelligence and Global Trade. My work
            has evolved from building AI-integrated full-stack applications to
            developing computational frameworks for EU Strategic Autonomy.
          </p>
          <p className="font-semibold text-cyan-950 text-xl leading-relaxed pt-6">
            ― Present Research Work
          </p>
          <p className="leading-relaxed text-justify">
            In a relatively short period, I have transitioned into the field of
            Computational Macro-Geopolitics and Economics, where I investigate
            how linguistic signals in policy and news precede physical shifts in
            trade flows. My current research proposes a Joint Topic-Stance (JTS)
            framework designed to map causal risk propagation across European
            Value Chains, moving beyond black-box sentiment analysis toward
            interpretable, causal 'Nowcasting' of trade disruptions.
          </p>
          <p className="leading-relaxed text-justify">
            I am particularly interested in how Temporal Causality and Causal
            Discovery can quantify the impact of exogenous shocks—such as
            geopolitical conflicts or policy shifts—on the resilience of the
            European Union's trade ecosystem.
          </p>
          <div className="flex justify-start">
            <div className="text-[#53528E]">
              <ul className="flex space-x-6 py-6 lg:pt-10">
                <li className="border-r-2 border-black pr-4">
                  <ResearchWebsiteButton />
                </li>
                <li className=" pr-4">
                  <DownloadProposal />
                </li>
        ...
        <div className="lg:pl-4">
          <p className="font-semibold text-cyan-950 text-xl leading-relaxed uppercase ">
            ― Research Interests
          </p>
          <ul className="pl-5 leading-relaxed list-disc  ">
            <li>Natural Language Processing (NLP) & Generation</li>
            <li>Sentiment Analysis</li>
            <li>Joint Topic-Stance (JTS) Modeling</li>
            <li>Causal Discovery & Temporal Causality</li>
            <li>Economic Resilience & Global Value Chains (GVCs)</li>
            <li>EU Trade Policy & Strategic Autonomy Frameworks</li>
          </ul>
        </div>
      </div>
      ...
      <div>
        <p className="font-medium text-cyan-950 text-xl leading-relaxed capitalize py-8"></p>
      </div>
    </div>
  );
}
