    ...
    <div className={`mt-24 md:mt-24 lg:mt-0`}>
      <div className='bg-[#F2F5F7] max-w-screen grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 px-4 py-6 sm:px-8 lg:px-24'>
        ...
        <div className='col-span-2 lg:col-span-3 h-fit my-auto space-y-8 sm:pr-4 lg:pr-0'>
          ...
          <div className='font-Playfair text-xl md:text-3xl lg:text-5xl font-semibold text-left tracking-wide'>
        ...
        {/* Right Section */}
        <div id='profil-img' className='justify-center lg:justify-start col-span-1 sm:col-span-2 lg:col-span-2 flex py-4 sm:py-8 lg:py-16'>
          <img
            src={ProfileImg}
